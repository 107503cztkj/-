	...
	<center><h1 class="title"><font color="#fcdbb1">│桃園大小事│</font></h1>
		...
		<thead>
			<tr class="info" style="color:#666">
				<th width="45">編號</th>
				<th width="400">標題</th>
				<th width="150">發佈日期</th>
				<th width="200">發佈單位</th></tr>
		</thead>
		<?php
				if($_GET["key"]<>""){
		...
		<tbody>
			...
			$data=mysql_query($sql) or die(mysql_error());
				...
				?>
				<td><?php echo $i ?></td>
				<td><a href="http://140.131.114.142/develop/BSthing2.php?e=<?php echo $row['ID']?>" style="color:#f8b359;"><?php echo $row['title']?></a></td>
