...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
	...
	<div class="content"> 
		...
		<div class="form-group">  
					...
					<input type="text" class="form-control" name="eventName" maxlength="30" value="<?php echo $row['eventName']?>" required />
				</div> 
				<div>
				...
				<div>
					...
					<input type="text" class="form-control" name="address" value="<?php echo $row['address'] ?>" style="width:400px" maxlength="25" required /></br></br>
					</div>
					<h3>活動內容:</h3><br>		
				<div align="center">	
