                 ...
                 <div class="col-xs-12">
                    ...
                    <table class="gridtable" width="60%">
                        ...
                        <tr>
                            ...
                            <td width="50%" ><a href="" data-toggle="modal" data-target="#modal-about-us-<?php echo $row['ID']?>"><?php echo $row['title']?></a></td>
                            </ul>
                            </nav>
                            </div>
...
<div class="modal-dialog" >
		<div class="modal-content">
			<div class="modal-header" data-background-color="#ffe256">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h2 class="modal-title" id="modal-about-us-label"><?php echo $row['title']?></h2>
               <div class="data"> <p>發布日期:<?php echo date('Y-m-d',strtotime($row['fdate']))?></p></div>
			</div>
						...
						<section>
							...
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="person">
										<div class="image">
											<div class="bg-transfer"><img src="cm/upload/news/<?php echo $row['pic']?>" alt=""></div>
										</div>
										<h4>檔案附件</h4>
										<h5>下載</h5>
									</div>
