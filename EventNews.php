	...
	<div class="content">   		       
		...
		<div class="item">
			<div class="photo"><img class="photo" src="upload/<?php echo $row['eventPic'] ?>"></div>
				<table>
					<tr>
						<td colspan="2"><b><a href="Event.php?f=<?php echo $row['eventID']?>"><font size="+1.5" color="#f29bda"><?php echo $row['eventName']?></font></a></b></td>
					</tr>
					<tr>
						<td colspan="2"><font color="#8dc7fc"><?php echo mb_substr($row['description'],0,15,"utf-8")?>....</font></td>
					</tr>
					<tr>
					...
					<tr>
						<td><font color="#a2acb5">已報名人數: <?php echo $count ?></font></td>
					</tr>
					<td colspan="2" class="button"><a href="Event.php?f=<?php echo $row['eventID']?>"><img src="images/<?php echo $statusPic ?>"></td>
				</table>
		</div>
		<?php
		}
