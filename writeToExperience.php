...
if($type=="image/jpeg" || $type=="image/png" || $type=="image/gif"){
  if($sizemb < 3){
	  ...
	  $sqlStr="insert into experiences (cusNickname, title, eventID, expPic, content) values('$cusNickname','$title','$eventID','$new_name','$content')";

	  mysql_query($sqlStr) or die("心得分享失敗! 請重新新增...");
	  echo "心得分享成功!感謝您的分享~  </br>頁面跳轉中...";
	  echo '<meta http-equiv=REFRESH CONTENT=2;url=History(afterlogin).php>';
