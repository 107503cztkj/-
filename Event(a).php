...
<body>
    ...
    <div id="header-wrapper">
        <div class="container">
			...
			?>
            <center><h1 class=title><?php echo $row['eventName']?></h1>	
			<label>【<?php echo $row['type']?>】</label>
			<?php echo "<input type=\"hidden\" name=\"eventID\" value=\"$row[eventID]\" readonly=\"value\" />"?>
			<div class="photo"><img src="upload/<?php echo $row['eventPic']?>" class="photo" width=70%></div></center>
			
			
                <table class="event" width=77%>
					<tr>
						<td width=10%>舉辦組織:</td>
                    ...
                    <tr>
						<td width=15%>活動地點:</td>
                        <td width=35%><?php echo $row['address']?></td>
                    </tr>
                </table>
				...
				<center><div id="btn"><a href="signUp.php?e=<?php echo $row['eventID']?>" class="button" onclick=alert("嗨!確定報名嗎?")><img src="images/joinbutton.png"></a></div></center>
