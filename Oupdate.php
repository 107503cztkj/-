...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    <div id="header-wrapper">
        <div class="container">
			...
			?>		
			<div>
				<form action="oUpdate_finish.php"  method="post">
					<div class="photo"><img class="photo" src="cus-comImg/<?php echo $row2['comPic'] ?>"></div>
                    <table>
                        <tr>
                    ...
                    <label><img src="images/thumbnail.png" /><input type="file" class="photobt"></label></br>
