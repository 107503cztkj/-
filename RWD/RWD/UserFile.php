                        ...
                        <div class="ace-nav-cont">
                            <div id="ace-nav-scroll">
                                <nav id="ace-nav" class="ace-nav">
                                    <ul class="clear-list">
										<li>
											<a href="index.php" data-tooltip="切換機構"><img class="avatar avatar-42" src="img/uploads/avatar/avatar-42x42.png" alt=""></a>
										</li>									
										<li>
    ...
    <div class="padd-box clear-mrg">
        <section class="section brd-btm">
            <div class="row">
                ...
                <div class="update"> <a href="Userupdate.php" title="編輯個人資料"><img src="img/pen.png" alt="" border="5"></a></div>

                    <p></br><?php echo $row['cusIntro'] ?>
                        </p>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 clear-mrg">
                    ...
                    <div class="progress-bullets ace-animate" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="10">
                        ...
                        <dd><?php echo $row['language'].$row['otherLanguage']?></dd>
                        
                        <dt class="text-upper">飲食習慣</dt>
                        <dd><?php echo $row['foodHabit']?></dd>
                    </dl>
                    </div>
                </div><!-- .col-sm-6 -->
            </div><!-- .row -->
