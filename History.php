								...
								<!-- 2 Columns -->
									<div class="flex flex-2">
										...
										<div class="col col2"><!---為了不跑版的設定-->
											<h3 style="color:#7a4a7c"><?php echo $row['title']?></h3><p>分享夥伴: <?php echo $row['cusNickname']?></p><p>發布日期: <?php echo date('Y-m-d',strtotime($row['add_time']))?></p>
											<p style="max-width:700px;color:#804040"><?php cut_content($row['content'],135);?></p>
											<a href="Experience.php?e=<?php echo $row['expID']?>" class="button">詳全文</a>
										</div>
									</div>
							</div>
						</section></br></br></br>
