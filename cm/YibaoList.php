...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		...
		<form action="UpdateYibao&Com.php"  method="post">
			...
			<tbody>
				<tr>
					...
					<td><?php echo $i ?></td>
					<td><a href="YibaoUserFile.php?f=<?php echo $row['cusID']?>" target="_blank"><?php echo $row['cusName'] ?></a></td>
			...
			<div class="DELETE">
					<a class="deletedata" style="text-decoration:none;" ><input type="submit" name="Ydeleteall" id="button"  value="刪除選取檔案" /></a>
			</div>
		</form>	
    ...
    <div class="addbt">
        <a href="AddExperience.php"><img src="images/addbt.png"></a>
    </div>
	<!------------------------------------------------>
	<!------------------------------------------------>
