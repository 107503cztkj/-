     ...
     <!--~~~~~~~~~~~~--> 
      <div id="wrapper1">
          <div id="three-column" class="container">
              ...
              <div id="tbox1">
                  <div class="title">
                      <a href="NewNewsCM.php"><h2>|最新消息|</h2></a>
                  </div>
				  <?php
					$sql="select * from news Order By fdate desc limit 0,10";
					$data=mysql_query($sql) or die(mysql_error());
					for($i=1;$i<=mysql_num_rows($data);$i++){
					$row=mysql_fetch_array($data);
					?>
                  <p><a href="NewNews2CM.php?e=<?php echo $row['newsID']?> "><?php cut_content($row['title'],17);?></a></p>
                  </p>
				  <?php
				  }
				  ?>
              ...
              <div id="tbox2"> 
                  <div class="title">
                      <a href="BSthingCM.php"><h2>|桃園大小事|</h2></a>
                  </div>
				   <?php
					...
					$row=mysql_fetch_array($data);
					?>
                  <p><a href="BSthing2CM.php?e=<?php echo $row['ID']?> "><?php cut_content($row['title'],17); ?></a></p>
                  </p>
				   <?php
					}
					?>
              ...
              <div id="tbox3">
                  <div class="title">
                      <a href="DownloadlistCM.php" style="text-decoration: none;"><h2>|下載專區|</h2></a>
                  </div>
				  <?php
					...
					$row=mysql_fetch_array($data);
					?>
                  <p><a href="DownloadlistCM.php"><?php cut_content($row['title'],17); ?></a></p>
				   <?php
					}
					?>
              </div>	
