...
<link href="css/BSthingCM.css" rel="stylesheet" type="text/css" />
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
	...
	<center><h1 class="title"><font color="#fcdbb1">│桃園大小事│</font></h1>
		...
		?>
			<form action="UpdateBSthing.php"  method="post">
				<table style="border:1px #cccccc solid;" cellpadding="10" border='1'>
					<thead>
						<tr class="info" style="color:#666" height="50">
							...
							<th width="50" height="5">#</th>
							<th width="700">標題</th>
							<th width="350">發布單位</th>
							<th width="60"></th>
							<th width="60"></th>
					...
					<tbody>
						<tr>
							...
							<td><?php echo $i ?></td>
							<td><a href="BSthing2CM.php?e=<?php echo $row['ID']?>"><?php echo $row['title']?></a></td>
							<td><?php echo $row['promulgator'] ?></td>
							<td><a class="button3" style="text-decoration:none;" href="BSthing2CM.php?e=<?php echo $row['ID']?>">編輯</a></td>
							<td><a class="button3" style="text-decoration:none;" href="UpdateBSthing.php?e=<?php echo $row['ID']?>">刪除</a></td>
				...
				<a class="button1"><input type="submit" name="deleteall" id="button1"  value="刪除選取檔案" /></a>
	...
	<div class="back">
		<label><img src="images/back.png" title="返回首頁">
			<a href="index.php"><input type="button" class="backbt" value="返回" /></a>
		</label>
	</div>

	<div class="addbt">
        <a href="AddBSthing.php"><img src="images/addbt.png" title="新增檔案"></a>
    </div>
	<!------------------------------------------------>
	<!------------------------------------------------>
