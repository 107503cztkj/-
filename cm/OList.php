...
<link href="css/OList.css" rel="stylesheet" type="text/css" />
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
	...
	<div class="content">
	<center><h1 class="title"><font color="#a2ba87">│機構列表│</font></h1>
		...
		<form action="UpdateYibao&Com.php"  method="post">
			...
			<tbody>
				<tr>
					<td><?php echo "<input type=\"checkbox\" name=\"IDrow[]\" value=\"$row[comID]\"/>";?></td>
					<td><?php echo $i ?></td>
					<td><a href="Ofile.php?f=<?php echo $row['comID']?>" target="_blank" style="color:#006400"><?php echo $row['comName'] ?><a/></td>
					<td><?php echo $row['principal'] ?></td>
					<td><?php echo $row['phone'] ?></td>
					<td><?php echo $row['comMail'] ?></td>
					<td><a class="button3" style="text-decoration:none;" href="UpdateYibao&Com.php?o=<?php echo $row['comID']?>">刪除</a></td>
				</tr>
			</tbody>
			<?php
			}
			...
			<div class="DELETE">
					<a class="deletedata" style="text-decoration:none;" ><input type="submit" name="Odeleteall" id="button"  value="刪除所選機構" /></a>
			</div>
		</form>
	...
	<div class="tocheck">
		<a href="Check.php"><img src="images/tocheck.png" title="進入審核清單"></a>
    </div>
	<!------------------------------------------------>
	<!------------------------------------------------>
