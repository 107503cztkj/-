		...
		<form action="UpdateYibao&Com.php"  method="post">
			...
			<tbody>
				<tr>
					...
					<td><?php echo $i ?></td>
					<td><a href="Ofile.php?f=<?php echo $row['comID']?>" target="_blank"><?php echo $row['comName'] ?><a/></td>
			...
			<div class="DELETE">
					<a class="deletedata" style="text-decoration:none;" ><input type="submit" name="Odeleteall" id="button"  value="刪除選取檔案" /></a>
			</div>
		</form>
