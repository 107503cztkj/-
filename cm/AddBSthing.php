        ...
        <div class="container">
			...
			<!--~~~~~~~~~~~~--> 
			 <div class="content">
				...
				<div id="page-wrapper">
				<form action="writeToBSthing.php"  method="post" enctype="multipart/form-data">
					<div id="page" class="container">
					<div id="sidebar">
						
							<ul class="default">
								<li>發佈單位:</li>
								<li><input type="text" name="promulgator" style="font-size:16px;width:200px;"></li></br>
						...
						<div>
							...
							附件上傳&nbsp <input type="file" name="file" size="20" accept=".doc,.docx,.pdf,.xls"/>
				
						<h3>消息內容:</h3> 
						<p>
						<textarea id="editor1" name="content" style="width:700px;height:450px;" required></textarea><br>
