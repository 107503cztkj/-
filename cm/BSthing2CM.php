			 ...
			 <div class="content">
				...
				<form action="UpdateBSthing.php"  method="post">
					...
					<div id="sidebar">
							...
							<ul class="default">
								<li>發佈單位:</li>
								<li><input type="text" name="name" style="font-size:16px;width:200px;" value="<?php echo $row['name'] ?>"></li></br>
						...
						<div id="content">
							<div class="title">
							<input type="hidden"  name="id" style="font-size:20px;width:700px;" value="<?php echo $row['ID']?>">
							<h3>標題:</h3>
