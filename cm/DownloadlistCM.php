...
<link href="css/DownloadlistCM.css" rel="stylesheet" type="text/css" />
<link href="fonts.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="http://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">

<link href="css/Head.css" rel="stylesheet" type="text/css" />
<link href="css/Search(simple1).css" rel="stylesheet" type="text/css" />
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
	...
	<div class="content">
	<center><h1 class="title"><font color="#fcdbb1">│下載專區│</font></h1>
		...
		?>
			<form action="UpdateDownload.php"  method="post">
				<table style="border:1px #cccccc solid;" cellpadding="10" border='1'>
					...
					<tbody>
						<tr>
							...
							<td><?php echo $i ?></td>
							<td class="edit" id="title_<?php echo $row['ID']?>"><?php echo $row['title']?></td>
							<td><a class="button3" style="text-decoration:none;" href="resetDownload.php?e=<?php echo $row['ID']?>">上傳更新檔案</a></td>
							<td><a class="button3" style="text-decoration:none;" href="UpdateDownload.php?e=<?php echo $row['ID']?>">刪除</a></td>
    ...
    <div class="addbt">
        <a href="AddDownload.php"><img src="images/addbt.png" title="新增檔案"></a>
    </div>
	<!------------------------------------------------>
	<!------------------------------------------------>
